...
COULD NOT FIND THIS PDF IN THE DRIVE ^^^ -Diana
...
However, by 2014, Chegg began promoting the "Chegg Cloud" as a broker/reseller which claimed to reach "8 out of 10 students actively researching schools online" by partnering with 18 of the top college search websites and mobile apps to aggregate student data and requests for information" [CITE CHEGG-2015-SOCIAL-ADMISSIONS-REPORT]. In 2017, Chegg entered a partnership whereby "NRCCUA will assume responsibility for managing, renewing, and maintaining our existing university contracts and become the exclusive reseller of our digital Enrollment Marketing services for colleges and universities" [CITE 2017 ANNUAL REPORT], effectively shuttling Chegg's enrollment marketing service. 

To this day, Chegg remains a successful company -- recording revenue of \$644 million in 2020 [2020 ANNUAL REPORT] compared to \$255 million in 2013 [2013 annual report], raising the question, why did Chegg's foray into the student list business fail? 
...
### Regulating Student List Filters, FTC
...
The Federal Trade Commission (FTC) regulates commerce at the federal level. Within the FTC, the Bureau of Consumer Protection "stops unfair, deceptive and fraudulent business practices by collecting reports from consumers and conducting investigations, suing companies and people that break the law, developing rules to maintain a fair marketplace" [CITE](https://www.ftc.gov/about-ftc/bureaus-offices/bureau-consumer-protection). In general, the FTC does not prohibit businesses from targeting particular localities, from targeting particular racial/ethnic groups, or from utilizing geodemographic methodologies when looking for customers for consumer products [CITE; IS THIS TRUE?]. 

However, the FTC has recently become interested in products that utilize artificial intelligence, algorithms, and predictive analytics, citing research which finds that "apparently 'neutral' technology can produce troubling outcomes – including discrimination by race or other legally protected classes" [CITE](https://www.ftc.gov/news-events/blogs/business-blog/2021/04/aiming-truth-fairness-equity-your-companys-use-ai). We believe that student list products fall into this class of products and, thus, should be subject to FTC srutiny.

The 2021 FTC blog "Aiming for truth, fairness, and equity in your company’s use of AI" [CITE](https://www.ftc.gov/news-events/blogs/business-blog/2021/04/aiming-truth-fairness-equity-your-companys-use-ai) provides useful information. Section 5 of the FTC Act "prohibits unfair or deceptive practices. That would include the sale or use of – for example – racially biased algorithms" ). In simple terms, the FTC Act considers a practice unfair "if it causes more harm than good." Importantly, this definition is concrned with "discriminatory outcomes" as opposed to whether the algorithm explicitly considered protected classes like race and gender. For example, the blog post stated that "If a data set is missing information from particular populations, using that data to build an AI model may yield results that are unfair or inequitable to legally protected groups." Applying this logic, College Board student list products include students who took the SAT, PSAT, or an AP exam. These products likely exhibit systemic racial bias in which students are excluded from the database, making them subject to FTC scrutiny. Moreover, considering racial inequality in the availability of AP coursework, allowing student list products to filter based on AP score, or based on taking an AP exam, may raise FTC scrutiny.

PASTED TEXT FROM BLOG POST
...
### Regulating Anti-competitive Behavior, FTC \& DOJ

- introduce FTC competition bureau and relevant concepts/regulations
- apply to student list vendors


### Regulating Universities, Department of Education

- Introduce relevant regulations/rules from HEA
- apply them to student list business
