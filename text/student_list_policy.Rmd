...
Across all student markets, achieving enrollment goals requires marketing and recruiting. As the process of recruiting students becomes increasingly sophisticated and competitive, many universities have adopted the contracting-out approach of hiring an enrollment management consulting firm to develop and implement recruiting campaigns. Contributing to this trend, university administrators often approach the enrollment management office like the impatient owner of a professional sports team, firing senior enrollment professionals if they fail to meet this year's enrollment targets. In turn, turnover within the enrollment management office reduces in-house capacity, making universities more reliant on contracting-out with consulting firms.
...
Having laid out the problems, how should policymakers think about regulating the student list business? To what extent should regulations focus on student list products and the vendors that create these products, or on the customers (universities) that buy student list? Focusing regulations on products and vendors rather than customers is conceptually attractive because lists purchased by universities are limited by what the product features allow. However, the Higher Education Act gives the U.S. Department of Education regulatory authority over Title IV institutions, not over "third party servicers" with the exception of student loan services. The Federal Trade Commission (FTC) has authority over commercial products. The FTC and the Department of Justice Antitrust Division have authority over antitrust issues. An alternative approach is to regulate universities. At present, neither federal nor state policy regulate student list purchases by universities. However, there may be scope for requiring universities to disclose information about student list purchases.
<!-- 
CUT TEXT
...
<!--TODO: [SAY THAT FAIR CREDIT REPORTING ACT REFERS TO ORGANIZATIONS AND FTC ACT REFERS TO PRODUCTS]-->
...
In the student list business, College Board and ACT satisfy the definition of oligopoly. As such, College Board and ACT may charge higher prices for student lists than would be charged in a competitive market. A potential example of "favorable terms of sale" is encouraging universities to purchase College Board/ACT enrollment management consulting services in order to gain access to data not included in student lists.
...
In 2021, both College Board and ACT charged \$0.50 per name, an example of parallel conduct in the student list business. However, it is unlikely that this price is a result of an agreement between College Board and ACT. Even if collusion occurred, proving it would be difficult. In conclusion,  the market position of College Board and ACT do not raise antitrust concerns because the Sherman Act prohibits horizontal agreements between oligopolists rather than prohibiting oligopoly per se.

__PowerSchool-EAB partnership and vertical restraints__. Vertical agreements are agreements between firms operating "at different levels of production, distribution, or supply" [@wspodcast, para. 1]. For example, a clothing retailer agrees to promote the products of a clothing manufacturer in exchange for a price discount. Vertical restraints are defined as vertical agreements that affect competition. Vertical restraints can increase competition or they can restrain competition. Antitrust law is concerned with vertical restraints that are anti-competitive in that "they hurt competition more than they help competition" including vertical agreements that "raise prices, limit output, restrain or exclude competitors, or decrease the available variety of products or services" [@wspodcast, para.9-10].
...
Antitrust case law identifies different kinds of vertical restraints. Most broadly, vertical restraints are categorized as price-based or non-price based. A common price-based vertical restraint, known as "resale price maintenance" occurs when a manufacturer and a distributor agree on the price a product will be sold for. Non-price vertical restraints include "exclusive dealing" agreements between a manufacturer and a distributor, in which the distributor agrees to not sell products made by other manufacturers. In "exclusive distribution" agreements -- often called "exclusive reseller" agreements -- only one distributor is authorized to sell the product of a manufacturer. The PowerSchool-EAB agreement makes EAB the exclusive reseller of the Intersect recruiting platform owned by PowerSchool.

@wspodcast describes recent changes on how antitrust law evaluates vertical restraints. A consistent position of the Supreme Court is that "Section 1 of the Sherman Act prohibits only unreasonable restraints on competition, not all restraints on competition" (para. 22). Following the 2007 Supreme Court case *Leegin Creative Leather Products v. PSKS*, antitrust law evaluates vertical restraints against the "rule of reason" analysis, which seeks to determine whether the agreement "has a substantial anti-competitive effect that harms consumers." Following the 2018 Supreme Court case *Ohio v. American Express*, plaintiffs alleging vertical restraint must first establish that the entity imposing the vertical restraint has market power in a "relevant market" because the Supreme Court "recognized that vertical restraints often pose no risk to competition unless the entity imposing them has market power" [@wspodcast, para. 25].
...
__Reporting requirements__. One condition of the program participation agreement states that Title IV institutions "will complete surveys conducted as a part of the Integrated Postsecondary Education Data System (IPEDS) or any other Federal postsecondary institution data collection effort, as designated by the Secretary" ([HEA section 487(a)(17)](https://www.law.cornell.edu/uscode/text/20/1094)). This reporting requirement empowers the Department of Education to request that Title IV institutions provide annual data about student list vendors. Providing such data need not be onerous for universities, even when they outsourced student list purchases to a consulting firm. We created a document that explains how to obtain prior student list purchases from the College Board and ACT online portals and how to remove personal information from these data. Moving forward, we hope to develop a tool that reads the data provided by a university, describes the characteristics of purchased prospects, and compares the characteristics of purchased prospects to other populations of interest (e.g., high school graduates in the county, metropolitan area, or state). To minimize burden, universities should not be required to provide information about student lists purchased from small student list vendors (e.g., Parchment). 

__Incentive compensation and third party vendors__. In 1992, Congress banned Title IV institutions from providing incentive compensation to university employees and third-party entities for "success in securing enrollments or financial aid" [@gao2010, p.3]. Practically speaking, the program participation agreement banned tuition sharing (payment based on number of students enrolled or percentage of tuition revenue of enrolled students), profit sharing (for-profit colleges distributing profits to employees based on number of students enrolled), and salary adjustments or bonuses to employees based on number of students enrolled. In 2002, the Bush Administration Department of Education issued "safe harbor" regulations defining 12 payment arrangements institutions could engage in without violating the incentive compensation ban [@gao2010, p.1]. For example, the safe harbors included compensation based on degree completion (\#5), profit distributions (\#9), and compensation -- including tuition-sharing -- to third-party bundled services that included recruitment (\#12). In 2010, the Obama Administration Department of Education eliminated the safe harbors.

However, in 2011 the Department of Education issued a guidance letter on incentive compensation, which stated that "tuition as a source of revenue from which compensation is paid to an unrelated third party for a variety of bundled services" would not be considered incentive compensation [@usde2011]. Critics have largely focused on the opportunities this "bundled services loophole" creates for online program management (OPM) companies to engage in tuition sharing agreements [@Shireman2019; @Dimino2020]. We are more interested in the Department of Education's rationale for the loophole:
...
Recent actions by the National Student Clearinghouse suggest that organizations capable of running the public option student list may be unwilling to take on the CRA designation. The National Student Clearinghouse is a nonprofit organization that was founded to overcome data sharing problems that undermined the functioning of the federal financial aid system, problems that could not be solved by the federal government due to the prohibition of a national student unit record system. Amongst other services, the Clearinghouse provides verification services (e.g., degree verification, enrollment verification) which enable postsecondary institutions, high schools, loan servicers, employers, and other entities to share sensitive information about students. Clearly, the Clearinghouse possesses expertise relevant to the public option student list. However, in 2019 a group of students sued the Clearinghouse, arguing that the organization met the criteria of a consumer reporting agency and therefore should not have charged students \$30 to obtain a copy of their report [@pierce2020]. The Clearinghouse settled the lawsuit but stated that it "'vigorously denies\ldots that it is a consumer reporting agency and that the FCRA…appl[ies] to it or its business practices'" [@pierce2020].
...
has completed national data collections of high school transcripts as part of the Longitudinal Studies Program since 1982 and as part of the National Assessment of Educational Progress (NAEP) since 1987 [@nces_hsts]. NCES could provide guidance about how to standardize transcript data for the public-option student list. Developing a standardized transcript database does not ensure that courses with the same course-code have the same content across schools. Nevertheless, our second reason for optimism is that advances in data science make achieving apples-to-apples comparisons less important. Enrollment management professionals -- consulting firms and also sophisticated in-house operations -- typically have detailed data about each high school and the postsecondary success of students from these schools. These data can be utilized to overcome concerns about comparing GPA or course-taking records across high schools.
