...
__FTC and student list products__. Student list _vendors_ clearly fall within the @RN4744 definition of "marketing data brokers." Increasingly, student list _products_ utilize data science methodologies and, thus, fall within the  @RN4743 interest in big data, algorithms, artificial intelligence, and predictive analytics because these products.^[For example, ACT states that the Encoura Platform -- which includes student lists -- "is an enrollment management technology platform that combines student intelligence data, advanced analytics" [@encoura_2021, para.2].] Contemporary student list products exhibit several features described as problematic by FTC guidelines (e.g., unrepresentative data, algorithms that consider inputs highly correlated with protected class, denying opportunities based on the behavior of others, etc.). Therefore, we recommend that FTC conduct a review of College Board student list products, ACT student list products, and PowerSchool's Intersect product. Although Intersect does not sell the contact information of Naviance users, it enables universities to control which Naviance user received advertising messages through the use of search filters that are similar to those used by College Board and ACT [@markup_naviance].
...
Antitrust regulators may be concerned that the exclusive reseller agreement negatively affects competition in the market for enrollment management consulting.^[Using a similar logic, the EAB acquisition of Cappex may raise concerns about vertical restraints to competition market for enrollment management consulting. Additionally, regulators may be concerned that College Board and ACT are negatively affecting competition by leveraging their position in the student list business to enter the market for enrollment management consulting.] EAB -- along with Ruffalo Noel Levitz -- is one of the two largest firms in this market. Naviance is reportedly used by 10 million U.S. students and by 40% of U.S. high schools [@powerschool], representing a substantial share of the college-going high school population. The exclusive reseller agreement may harm other enrollment management consulting firms (competitors) because universities may reason that hiring EAB is the only way to recruit high school students using Naviance. For example, a University of Utah procurement request document states that the "justification" for subscribing to Intersect is that "there is a unique group of prospective students who are only in the PowerSchool Naviance platform [CITE; DOC IN POWERSCHOOL GOOGLE DRIVE]. In turn, competitor EM consultancies will be less able to find prospects for their own clients, making them less valuable to universities. Additionally, the agreement may harm universities that are not customers of EAB; these universities may be unable to recruit high school students that use Naviance because EAB funnels Naviance users to EAB client universities.

Why should we care about competition in the market for enrollment management consulting? 

- most of t4 institutions consulting w/ two firms
- has the consequences of collusion
- 
