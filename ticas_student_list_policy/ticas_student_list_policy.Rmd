...
__The public option__. Administrative data already collected by U.S. high school/districts (e.g., contact information, GPA, course-taking by subject) provides the basis for a viable student list product. Increasingly, states have incorporated high school administrative data into statewide longitudinal data systems. Although not based on state administrative data, we learned that the Arizona Board of Regents works with high schools to provide the contact information of current high school students to Arizona public universities (personal communication).
