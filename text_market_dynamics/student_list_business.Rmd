...
To this day, Chegg remains a successful company -- recording revenue of \$644 million in 2020 [@chegg2020] -- raising the question, why did Chegg's foray into the student list business fail? Enrollment management consultants we spoke with had little respect for names provided by Chegg and similar providers. A principal concern was coverage; universities often target particular subsets of prospective students but the names contained by these lists were a sparse, scattered subset of all prospects. Second, consultants criticized the low quality of these data (e.g., many missing fields), a function of names being generated from voluntary online survey responses. Another concern was timeliness. College Board and ACT generate student list data early in the college search process (e.g., PSAT, PreACT). By contrast, names cannot be derived from college search websites until students start searching for college. Finally, it may be difficult to create a foothold in the student list business based on user data from college search engines, a competitive market with few barriers to entry.
...
__EAB business model__. Analyzing the EAB business model is difficult because privately owned companies have neither the requirement nor the incentive to disclose information.^[In May 2021, BC Partners -- a British private equity firm with over \$40 billion under management -- announced an investment in EAB [@bc_partners_2021]. In June 2021, Moody's Investor Service "assigned B2 ratings" -- a speculative, not of investment grade rating -- to EAB debt "consisting of a \$745 million term loan and a \$125 million revolver," but stated that upon completion of the investment by BC Partners, "Moody's expects EAB's existing debt to be repaid and ratings on these instruments to be withdrawn" [@moodys_2021, para.1]. In August 2021, the "plan by global investors BC Partners and Vista Equity Partners to acquire joint control over U.S. education company EAB Global Inc. received EU antitrust clearance" [@westlaw_2021, para.1]. Terms of the deal were not disclosed because all parties are privately owned.] The IPO prospectus of PowerSchool, formerly a Vista subsidiary, may provide insight about EAB. @powerschool_ipo states that:
...
__Enrollment management consulting__
...
The test-optional movement is an existential threat to College Board and ACT student list products. According FairTest.org, "immediately before the COVID-19 pandemic," 1,071 baccalaureate granting institutions had test-optional or test-blind admissions policies [[CITE](https://www.fairtest.org/more-1815-schools-do-not-require-actsat-scores-cur)]. As of December 2021, "more than 1,815 colleges and universities now practice test-optional or test-blind admissions" for the fall 2022 admissions cylcle and the "list includes nearly all of the nation’s most selective colleges and universities" [[CITE](https://www.fairtest.org/more-1815-schools-do-not-require-actsat-scores-cur)]. Furthermore, at least 1,400 institutions have extended test-optional and test-blind policies through the fall 2023 admissions cycle [[CITE](https://www.fairtest.org/more-1815-schools-do-not-require-actsat-scores-cur)], which suggests that the adoption of these policies will persist beyond the Covid pandemic.

The number of SAT and ACT test takers have also declined in recent years. The number of SAT test takers was 2.14 million for the class of 2018 [[CITE](https://reports.collegeboard.org/pdf/2018-total-group-sat-suite-assessments-annual-report.pdf)], 2.22 million for the class of 2019, 2.20 million for the class of 2020 [[CITE](https://reports.collegeboard.org/pdf/2019-total-group-sat-suite-assessments-annual-report.pdf)], and 1.51 million for the class of 2021 [[CITE](https://reports.collegeboard.org/pdf/2021-total-group-sat-suite-assessments-annual-report.pdf)]. The number of ACT test-takers changed from about 1.91 million in 2018, 1.78 million in 2019, 1.67 million in 2020, and 1.3 million in 2021 [[GET NON WIKIPEDIA CITE](https://en.wikipedia.org/wiki/ACT_(test))].
